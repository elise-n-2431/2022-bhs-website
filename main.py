...
def home():
    ...
    contents=connectsql("db/HomePageContent.db","SELECT content,size FROM Content ORDER BY box")
    content=[]
    size=[]
    for item in contents:
        content.append(item[0])
        size.append(item[1])
    return render_template('home.html', num1=num1,num2=num2,num3=num3,name1=name1,name2=name2,name3=name3,col1=col1,col2=col2,col3=col3,content=content,size=size)
